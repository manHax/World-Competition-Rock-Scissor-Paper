...
public class RockPaperScissor {
    ...
    static void combatWithWins(Person p1,Person p2, int agr){
        p1.wins=0;
        p2.wins=0;
        int battleID=0;
